...
public class SmsUtils {
    ...
    public static boolean isKnownNumber(String phoneNumber) {
        if (isNullOrEmpty(phoneNumber)) {
            return false;
        } else if (ContentManager.getInstance().getContactsMap() == null ||
                isNullOrEmpty(ContentManager.getInstance().getContactsMap()
                        .get(phoneNumber)) || ContentManager.getInstance().getContactsMap()
     ...
     * @param phoneNumber number whose contact names is to be found
     * @return contact name
     */
